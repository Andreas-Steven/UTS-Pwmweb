        ...
        <div class="container" style="border:0.5px solid #cecece; padd">    
            ...
            <form action="" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"  value="<?php echo $Row['item_name']; ?>" disabled>
                    <input type="hidden" class="form-control" name="NB"  value="<?php echo $Row['item_name']; ?>">
                </div>
                ...
                <input type="button" value="Cancel" class="btn btn-primary" onClick="document.location.href='../../View/Kasir/Tampilan_Kasir.php';"/> <!--https://stackoverflow.com/questions/4553714/cancel-button-using-php-->
            </form>
            <br>
        </div>
        </div>
            ...
            if($_POST['HB'] != 0)
            {
                ...
                else
                {
                    ...
                    if($_POST['HB'] <= 0)
                    {
                        ...
                        header("Location: ../../View/Kasir/Tampilan_Edit_Kasir.php?id=$id");
                    }
